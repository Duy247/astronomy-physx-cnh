...
$gallery = json_decode(file_get_contents(__DIR__ . '/gallery/gallery_solarsystem_moon.json'), true);
?>

<main class="astro-card">
    <section class="astro-section">
        <h2 style="margin-bottom:0.5em;">Solar System - Moon</h2>
...
<?php include $_SERVER['DOCUMENT_ROOT'] . '/includes/aladin_moon.php'; ?>
